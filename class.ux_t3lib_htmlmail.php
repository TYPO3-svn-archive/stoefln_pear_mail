...
class ux_t3lib_htmlmail extends t3lib_htmlmail{
    ...
    */
    ...
    public function mail($to,$subject,$message,$headers=array())
    {
        ...
        // laden der Konfiguration der Extension
        ...
        if (PEAR::isError($mail_object)) {            
 		if ($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['stoefln_pear_mail']['smtpDebug']) t3lib_div::debug(Array('stoefln_pear_mail/htmlmail'=>'PEAR::isError($mail_object) !!!!!!!!!!!!!!!!', 'File:Line'=>__FILE__.':'.__LINE__));
          $error = true;
        } else {
           $error = false;
        };
